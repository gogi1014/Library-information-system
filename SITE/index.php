...
<body>
  ...
  <?php if (isset($_GET['search']) && $_GET['search'] != "" && (isset($_COOKIE["username"]))) { ?>
    <div id="type_view">
      <form method="post">
  ...
  <div id="content">
    ...
    if (isset($_GET['search']) && $_GET['search'] != "") {
      ...
      if ($_GET['search_type'] == "tag") {
        search("TAG", $con, $offset, $no_of_records_per_page);
        $var = "TAG";
      }
  ...
  <?php if (isset($_GET['search']) && $_GET['search'] != "") { ?>
    ...
    <div class="pagg">
      ...
      for ($i = 1; $i <= $total_pages; $i++) {
        $pagLink .= '<li class="page-item"><a class="page-link" href="?pageno=' . $i . '&search=' . $_GET['search'] . '&search_type=' . $_GET['search_type'] . '" >' . $i . '</a></li>';
      }
      echo $pagLink . "</ul>";
